...
####
## !define INFO_PROJECTNAME    "my-project" # Default "Malina"
## !define INFO_COMPANYNAME    "My Company" # Default "Melting Core"
## !define INFO_PRODUCTNAME    "My Product Name" # Default "Malina"
